# Weblate helper repository for subscription-manager-cockpit
...
Great! Please do so in https://translate.stg.fedoraproject.org/projects/subscription-manager-cockpit

## I found wrong translation
You can fix it in [Weblate](https://translate.stg.fedoraproject.org/projects/cockpit/subscription-manager-cockpit) directly, but if you don't want to register and become translator, please [open an issue](https://github.com/cockpit-project/cockpit-podman/) and maintainers will fix it in Weblate in your stead.
